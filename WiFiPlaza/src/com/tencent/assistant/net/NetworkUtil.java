...
public class NetworkUtil {
	...
	public static boolean is2G() {
		final APN apn = getApn();
		return apn == APN.CMNET || apn == APN.CMWAP || apn == APN.UNINET
				|| apn == APN.UNIWAP;
	}

	public static boolean is3G() {
		final APN apn = getApn();
		return apn == APN.CTWAP || apn == APN.CTNET || apn == APN.WAP3G
				|| apn == APN.NET3G;
	}
	...
	public static void refreshNetwork() {
		netInfo = getNetInfo(App.GlobalContext);
	}
	...
	public static boolean IsAirModeOn(Context context) {
		return (android.provider.Settings.System.getInt(
				...
				android.provider.Settings.System.AIRPLANE_MODE_ON, 0) == 1 ? true
				: false);
	}
